...
namespace PrinterManagerProject.EF
{
    ...
    public partial class tWarningBak
    {
        ...
        public Nullable<int> printing_status { get; set; }
        public Nullable<int> printing_model { get; set; }
        ...
        public string detection_drug_name { get; set; }
